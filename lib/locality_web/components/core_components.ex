defmodule LocalityWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LocalityWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LocalityWeb.Gettext, "errors", msg, opts)
    end
  end
